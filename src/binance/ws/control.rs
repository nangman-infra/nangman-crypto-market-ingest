use super::super::{BinanceIngestError, stats::BinanceL0GapAlert, stats::BinanceL0WatchStats};
use crate::clock;
...
pub(super) fn spawn_shutdown_flag() -> Result<Arc<AtomicBool>, BinanceIngestError> {
...
pub(super) fn record_reconnect(stats: &mut BinanceL0WatchStats, reason: &'static str) {
